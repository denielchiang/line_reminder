defmodule LineReminderWeb do
  ...
  def static_paths, do: ~w(assets fonts images xlsx favicon.ico robots.txt)
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {LineReminderWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        statics: LineReminderWeb.static_paths()
    end
  end
