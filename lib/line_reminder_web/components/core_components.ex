defmodule LineReminderWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LineReminderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LineReminderWeb.Gettext, "errors", msg, opts)
    end
  end
